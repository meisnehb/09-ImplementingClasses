...
class Point(object):
    ...
    def move_to(self, x, y):
        self.distanceSum = self.distanceSum + (((x - self.x) ** 2) + ((y - self.y) ** 2)) ** 0.5
    ...
    def move_by(self, dx, dy):
        self.distanceSum = self.distanceSum + (((self.x + dx - self.x) ** 2) + ((self.y + dy - self.y) ** 2)) ** 0.5
    ...
    def closer_to(self, p2, p3):
        distanceP2 = self.get_distance_from(p2)
        distanceP3 = self.get_distance_from(p3)
